const tariffData = {
    ...
    "Belarus": { imports: "<1%", previous: "10%", updated: "10%" },
...
const countryCodeToName = {
    ...
    'SGP': 'Singapore', 'USA': 'United States', 'FRA': 'European Union', 'DEU': 'European Union', 
    'ITA': 'European Union', 'ESP': 'European Union', 'PRT': 'European Union', 'BEL': 'European Union', 
    'NLD': 'European Union', 'LUX': 'European Union', 'AUT': 'European Union', 'FIN': 'European Union', 
    'SWE': 'European Union', 'IRL': 'European Union', 'DNK': 'European Union', 'GRC': 'European Union', 
    'HRV': 'European Union', 'BGR': 'European Union', 'CYP': 'European Union', 'CZE': 'European Union', 
    'EST': 'European Union', 'HUN': 'European Union', 'LVA': 'European Union', 'LTU': 'European Union', 
    'MLT': 'European Union', 'POL': 'European Union', 'ROU': 'European Union', 'SVK': 'European Union', 
    'SVN': 'European Union', 'AFG': 'Afghanistan', 'ALB': 'Albania', 'DZA': 'Algeria', 'AND': 'Andorra', 
    'AGO': 'Angola', 'AIA': 'Anguilla', 'ATG': 'Antigua and Barbuda', 'ARG': 'Argentina', 'ARM': 'Armenia', 
    'ABW': 'Aruba', 'AUS': 'Australia', 'AZE': 'Azerbaijan', 'BHS': 'Bahamas', 'BHR': 'Bahrain', 
    'BGD': 'Bangladesh', 'BRB': 'Barbados', 'BLR': 'Belarus', 'BLZ': 'Belize', 'BEN': 'Benin', 
    'BMU': 'Bermuda', 'BTN': 'Bhutan', 'BOL': 'Bolivia', 'BIH': 'Bosnia and Herzegovina', 'BWA': 'Botswana', 
    'IOT': 'British Indian Ocean Territory', 'VGB': 'British Virgin Islands', 'BRN': 'Brunei', 'BDI': 'Burundi', 
    'KHM': 'Cambodia', 'CMR': 'Cameroon', 'CPV': 'Cape Verde', 'CYM': 'Cayman Islands', 'CAF': 'Central African Republic', 
    'TCD': 'Chad', 'CHL': 'Chile', 'CXR': 'Christmas Island', 'CCK': 'Cocos (Keeling) Islands', 'COL': 'Colombia', 
    'TWN': 'Taiwan', 'COM': 'Comoros', 'COK': 'Cook Islands', 'CRI': 'Costa Rica', 'CIV': "Côte d'Ivoire", 
    'CUW': 'Curaçao', 'COD': 'Democratic Republic of the Congo', 'DJI': 'Djibouti', 'DMA': 'Dominica', 
    'DOM': 'Dominican Republic', 'ECU': 'Ecuador', 'EGY': 'Egypt', 'SLV': 'El Salvador', 'GNQ': 'Equatorial Guinea', 
    'ERI': 'Eritrea', 'SWZ': 'Eswatini (Swaziland)', 'ETH': 'Ethiopia', 'FLK': 'Falkland Islands', 'FJI': 'Fiji', 
    'GUF': 'French Guiana', 'PYF': 'French Polynesia', 'GAB': 'Gabon', 'GMB': 'Gambia', 'GEO': 'Georgia', 
    'GHA': 'Ghana', 'GIB': 'Gibraltar', 'GRD': 'Grenada', 'GLP': 'Guadeloupe', 'GTM': 'Guatemala', 
    'GIN': 'Guinea', 'GNB': 'Guinea-Bissau', 'GUY': 'Guyana', 'HTI': 'Haiti', 'HND': 'Honduras', 
    'ISL': 'Iceland', 'IDN': 'Indonesia', 'IRN': 'Iran', 'IRQ': 'Iraq', 'ISR': 'Israel', 'JAM': 'Jamaica', 
    'JOR': 'Jordan', 'KAZ': 'Kazakhstan', 'KEN': 'Kenya', 'KIR': 'Kiribati', 'XKX': 'Kosovo', 'KWT': 'Kuwait', 
    'KGZ': 'Kyrgyzstan', 'LAO': 'Laos', 'LBN': 'Lebanon', 'LSO': 'Lesotho', 'LBR': 'Liberia', 'LBY': 'Libya', 
    'LIE': 'Liechtenstein', 'MDG': 'Madagascar', 'MWI': 'Malawi', 'MDV': 'Maldives', 'MLI': 'Mali', 
    ...
    'NRU': 'Nauru', 'NPL': 'Nepal', 'NZL': 'New Zealand', 'NIC': 'Nicaragua', 'NER': 'Niger', 'NGA': 'Nigeria', 
    'MKD': 'North Macedonia', 'NOR': 'Norway', 'OMN': 'Oman', 'PAK': 'Pakistan', 'PAN': 'Panama', 
    'PNG': 'Papua New Guinea', 'PRY': 'Paraguay', 'PER': 'Peru', 'PHL': 'Philippines', 'QAT': 'Qatar', 
    'COG': 'Republic of the Congo', 'RWA': 'Rwanda', 'SHN': 'Saint Helena', 'KNA': 'Saint Kitts and Nevis', 
    'LCA': 'Saint Lucia', 'VCT': 'Saint Vincent and the Grenadines', 'WSM': 'Samoa', 'SMR': 'San Marino', 
    'STP': 'São Tomé and Príncipe', 'SAU': 'Saudi Arabia', 'SEN': 'Senegal', 'SRB': 'Serbia', 'SLE': 'Sierra Leone', 
    'SXM': 'Sint Maarten', 'SLB': 'Solomon Islands', 'ZAF': 'South Africa', 'SSD': 'South Sudan', 'LKA': 'Sri Lanka', 
    'SDN': 'Sudan', 'SUR': 'Suriname', 'SYR': 'Syria', 'TJK': 'Tajikistan', 'TZA': 'Tanzania', 'TLS': 'Timor-Leste', 
    'TGO': 'Togo', 'TKL': 'Tokelau', 'TON': 'Tonga', 'TTO': 'Trinidad and Tobago', 'TUN': 'Tunisia', 'TUR': 'Turkey', 
    'TKM': 'Turkmenistan', 'TCA': 'Turks and Caicos Islands', 'TUV': 'Tuvalu', 'UGA': 'Uganda', 'UKR': 'Ukraine', 
    'ARE': 'United Arab Emirates', 'URY': 'Uruguay', 'UZB': 'Uzbekistan', 'VUT': 'Vanuatu', 'VEN': 'Venezuela', 
    'YEM': 'Yemen', 'ZMB': 'Zambia', 'ZWE': 'Zimbabwe', 'HMD': 'Heard and McDonald Islands', 'SJM': 'Svalbard and Jan Mayen',
    ...
    'SPM': 'Saint Pierre and Miquelon', 'SYC': 'Seychelles', 'SOM': 'Somalia', 
    'SGS': 'South Georgia and the South Sandwich Islands', 'UMI': 'United States Minor Outlying Islands', 
    'VIR': 'United States Virgin Islands', 'WLF': 'Wallis and Futuna', 'ESH': 'Western Sahara'
};

const numericToAlpha3 = {
    "156": "CHN", "392": "JPN", "410": "KOR", "826": "GBR", "356": "IND", "764": "THA", "704": "VNM",
    "756": "CHE", "076": "BRA", "458": "MYS", "702": "SGP", "840": "USA", "250": "FRA", "276": "DEU", 
    "380": "ITA", "724": "ESP", "620": "PRT", "056": "BEL", "528": "NLD", "442": "LUX", "040": "AUT", 
    "246": "FIN", "752": "SWE", "372": "IRL", "208": "DNK", "300": "GRC", "191": "HRV", "100": "BGR", 
    "196": "CYP", "203": "CZE", "233": "EST", "348": "HUN", "428": "LVA", "440": "LTU", "470": "MLT", 
    "616": "POL", "642": "ROU", "703": "SVK", "705": "SVN", "004": "AFG", "008": "ALB", "012": "DZA", 
    "020": "AND", "024": "AGO", "660": "AIA", "028": "ATG", "032": "ARG", "051": "ARM", "533": "ABW", 
    "036": "AUS", "031": "AZE", "044": "BHS", "048": "BHR", "050": "BGD", "052": "BRB", "112": "BLR", 
    "084": "BLZ", "204": "BEN", "060": "BMU", "064": "BTN", "068": "BOL", "070": "BIH", "072": "BWA", 
    "086": "IOT", "092": "VGB", "096": "BRN", "108": "BDI", "116": "KHM", "120": "CMR", "132": "CPV", 
    "136": "CYM", "140": "CAF", "148": "TCD", "152": "CHL", "162": "CXR", "166": "CCK", "170": "COL", 
    "158": "TWN", "174": "COM", "184": "COK", "188": "CRI", "384": "CIV", "531": "CUW", "180": "COD", 
    "262": "DJI", "212": "DMA", "214": "DOM", "218": "ECU", "818": "EGY", "222": "SLV", "226": "GNQ", 
    "232": "ERI", "748": "SWZ", "231": "ETH", "238": "FLK", "242": "FJI", "254": "GUF", "258": "PYF", 
    "266": "GAB", "270": "GMB", "268": "GEO", "288": "GHA", "292": "GIB", "308": "GRD", "312": "GLP", 
    "320": "GTM", "324": "GIN", "624": "GNB", "328": "GUY", "332": "HTI", "340": "HND", "352": "ISL", 
    "360": "IDN", "364": "IRN", "368": "IRQ", "376": "ISR", "388": "JAM", "400": "JOR", "398": "KAZ", 
    "404": "KEN", "296": "KIR", "414": "KWT", "417": "KGZ", "418": "LAO", "422": "LBN", "426": "LSO", 
    "430": "LBR", "434": "LBY", "438": "LIE", "450": "MDG", "454": "MWI", "462": "MDV", "466": "MLI", 
    "584": "MHL", "474": "MTQ", "478": "MRT", "480": "MUS", "175": "MYT", "583": "FSM", "498": "MDA", 
    "492": "MCO", "496": "MNG", "499": "MNE", "500": "MSR", "504": "MAR", "508": "MOZ", "104": "MMR", 
    "516": "NAM", "520": "NRU", "524": "NPL", "554": "NZL", "558": "NIC", "562": "NER", "566": "NGA", 
    "807": "MKD", "578": "NOR", "512": "OMN", "586": "PAK", "591": "PAN", "598": "PNG", "600": "PRY", 
    "604": "PER", "608": "PHL", "634": "QAT", "178": "COG", "646": "RWA", "654": "SHN", "659": "KNA", 
    "662": "LCA", "670": "VCT", "882": "WSM", "674": "SMR", "678": "STP", "682": "SAU", "686": "SEN", 
    "688": "SRB", "694": "SLE", "534": "SXM", "090": "SLB", "710": "ZAF", "728": "SSD", "144": "LKA", 
    "729": "SDN", "740": "SUR", "760": "SYR", "762": "TJK", "834": "TZA", "626": "TLS", "768": "TGO", 
    "776": "TON", "780": "TTO", "788": "TUN", "792": "TUR", "795": "TKM", "796": "TCA", "798": "TUV", 
    "800": "UGA", "804": "UKR", "784": "ARE", "858": "URY", "860": "UZB", "548": "VUT", "862": "VEN", 
    "887": "YEM", "894": "ZMB", "716": "ZWE", "334": "HMD", "744": "SJM", "016": "ASM", "010": "ATA", 
    "854": "BFA", "124": "CAN", "192": "CUB", "408": "PRK", "234": "FRO", "260": "ATF", "304": "GRL", 
    "316": "GUM", "344": "HKG", "446": "MAC", "484": "MEX", "540": "NCL", "570": "NIU", "574": "NFK", 
    "580": "MNP", "275": "PSE", "612": "PCN", "630": "PRI", "638": "REU", "643": "RUS", "652": "BLM", 
    "663": "MAF", "666": "SPM", "690": "SYC", "706": "SOM", "239": "SGS", "581": "UMI", "850": "VIR", 
    "876": "WLF", "732": "ESH"
};
